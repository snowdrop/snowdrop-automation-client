...
export class Jira {
     ...
     * See https://docs.atlassian.com/software/jira/docs/api/REST/7.12.1/#api/2/issue-createIssue for the available fields.
     * 
     ...
     */
    async cloneIssue(key: string, projectId: string, parentId?: string) {
     ...
     */
    async getProjectId(projectKey: string) {
